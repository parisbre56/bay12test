...
$two_y = 7*$free_y+($bb_one[1]-$bb_one[7])+$free_y;
$three_x = ($image_x-($bb_three[4]-$bb_three[6]))/2;
$three_y = 7*$free_y+($bb_one[1]-$bb_one[7])+$free_y+($bb_two[1]-$bb_two[7])+$free_y;
$four_x = ($image_x-($bb_four[4]-$bb_four[6]))/2;
$four_y = 7*$free_y+($bb_one[1]-$bb_one[7])+$free_y+($bb_two[1]-$bb_two[7])+$free_y+($bb_three[1]-$bb_three[7])+$free_y;
